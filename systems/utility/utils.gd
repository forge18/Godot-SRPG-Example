const TILE_SRC = "res://systems/map/tile.gd"

enum UNIT_TYPES {Knight, Archer, Chemist, Cleric, Skeleton, SkeletonCPT, SkeletonMage}
enum UNIT_STRATEGIES {Tank, Flank, Support}
...
static func get_unit_sprite(var unit_type):
	match unit_type:
...
static func get_unit_move_radius(var unit_type):
	match unit_type:
		0: return 3
		1: return 5
		2: return 4
...
static func get_unit_jump_height(var unit_type):
	match unit_type:
		0: return 0.5
		1: return 3
		2: return 1
...
static func get_unit_attack_radious(var unit_type):
	match unit_type:
		0: return 1
		1: return 6
		2: return 3
...
static func get_unit_attack_power(var unit_type):
	match unit_type:
		0: return 20
		1: return 10
		2: return 12
...
static func get_unit_health(var unit_type):
	match unit_type:
		0: return 50
		1: return 35
		2: return 30
